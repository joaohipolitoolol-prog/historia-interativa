...
export function StickyCTA() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 border-t border-border bg-white/95 backdrop-blur-md shadow-[0_-8px_30px_rgba(23,32,51,0.08)]">
      <div className="container-page flex items-center gap-3 py-3">
        ...
        <button
          ...
          className="shrink-0 rounded-lg p-2 text-muted hover:bg-cream"
        >
          ×
        </button>
      </div>
